...
class Admin extends CI_Controller
{
    ...
    function dashboard()
    {
        ...
        $page_data['page_title'] = ucwords('admin_dashboard');
	...
	function student_add()
	{
		...
		$page_data['page_title'] = ucwords('add_student');
		$this->load->view('backend/index', $page_data);
	}
	...
	function student_bulk_add($param1 = '')
	{
		...
		$page_data['page_title'] = ucwords('add_bulk_student');
		$this->load->view('backend/index', $page_data);
	}
	...
	function student_information($class_id = '')
	{
		...
		$page_data['page_title'] 	= ucwords('student_information'). " - ".ucwords('class')." : ".
	...
	function student_marksheet($class_id = '')
	{
		...
		$page_data['page_title'] 	= ucwords('student_marksheet'). " - ".ucwords('class')." : ".
											$this->crud_model->get_class_name($class_id);
		$page_data['class_id'] 	= $class_id;
		$this->load->view('backend/index', $page_data);
	}
    ...
    function student($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , ucwords('data_added_successfully'));
        ...
        if ($param2 == 'do_update') {
            ...
            $this->session->set_flashdata('flash_message' , ucwords('data_updated'));
        ...
        if ($param2 == 'delete') {
            ...
            $this->session->set_flashdata('flash_message' , ucwords('data_deleted'));
            redirect(base_url() . 'index.php?admin/student_information/' . $param1, 'refresh');
        }
    }
    ...
    function parent($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] 	= ucwords('all_parents');
    ...
    function teacher($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = ucwords('manage_teacher');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function subject($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        $page_data['page_title'] = ucwords('manage_subject');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function classes($param1 = '', $param2 = '')
    {
        ...
        $page_data['page_title'] = ucwords('manage_class');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function section($class_id = '')
    {
        ...
        $page_data['page_title'] = ucwords('manage_sections');
        $page_data['class_id']   = $class_id;
        $this->load->view('backend/index', $page_data);    
    }
    ...
    function exam($param1 = '', $param2 = '' , $param3 = '')
    {
        ...
        $page_data['page_title'] = ucwords('manage_exam');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function exam_marks_sms($param1 = '' , $param2 = '')
    {
        ...
        if ($param1 == 'send_sms') {
            ...
            $this->session->set_flashdata('flash_message' , ucwords('message_sent'));
            redirect(base_url() . 'index.php?admin/exam_marks_sms' , 'refresh');
        }
                
        $page_data['page_name']  = 'exam_marks_sms';
        $page_data['page_title'] = ucwords('send_marks_by_sms');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function marks($exam_id = '', $class_id = '', $subject_id = '')
    {
        ...
        $page_data['page_title'] = ucwords('manage_exam_marks');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function grade($param1 = '', $param2 = '')
    {
        ...
        $page_data['page_title'] = ucwords('manage_grade');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function class_routine($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = ucwords('manage_class_routine');
        $this->load->view('backend/index', $page_data);
    }
	...
	function manage_attendance($date='',$month='',$year='',$class_id='')
	{
        ...
        $page_data['page_title'] =	ucwords('manage_daily_attendance');
		$this->load->view('backend/index', $page_data);
	}
    ...
    function invoice($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'take_payment') {
            ...
            $this->session->set_flashdata('flash_message' , ucwords('payment_successfull'));
            redirect(base_url() . 'index.php?admin/invoice', 'refresh');
        }
        ...
        $page_data['page_title'] = ucwords('manage_invoice/payment');
    ...
    function save_billing(){
            ...
            $data['paid']               = $this->input->post('amount_paid');
          ...
          /*  $invoice_id = $this->db->insert_id();
            ...
            $this->session->set_flashdata('flash_message' , ucwords('data_added_successfully'));
            redirect(base_url() . 'index.php?admin/billing', 'refresh');
       

    }
    function billing($param1 = '' , $param2 = '')
    {
      
        $page_data['page_name']  = 'billing';
        $page_data['page_title'] = ucwords('billing');
       // $this->db->order_by('creation_timestamp', 'desc');
        $page_data['invoices'] = $this->db->get('records')->result_array();
        $this->load->view('backend/index', $page_data); 
    }
    ...
    function income($param1 = '' , $param2 = '')
    {
       if ($this->session->userdata('admin_login') != 1)
        ...
        $page_data['page_title'] = ucwords('incomes');
        $this->db->order_by('creation_timestamp', 'desc');
        $page_data['invoices'] = $this->db->get('invoice')->result_array();
        $this->load->view('backend/index', $page_data); 
    }
    ...
    function expense($param1 = '' , $param2 = '')
    {
        ...
        $page_data['page_title'] = ucwords('expenses');
        $this->load->view('backend/index', $page_data); 
    }
    ...
    function expense_category($param1 = '' , $param2 = '')
    {
        ...
        $page_data['page_title'] = ucwords('expense_category');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function book($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = ucwords('manage_library_books');
        $this->load->view('backend/index', $page_data);
    ...
    function transport($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = ucwords('manage_transport');
        $this->load->view('backend/index', $page_data);
    ...
    function dormitory($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title']  = ucwords('manage_dormitory');
        $this->load->view('backend/index', $page_data);
    ...
    function noticeboard($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        $page_data['page_title'] = ucwords('manage_noticeboard');
    ...
    function message($param1 = 'message_home', $param2 = '', $param3 = '') {
        ...
        $page_data['page_title']                = ucwords('private_messaging');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function system_settings($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'upload_logo') {
            ...
            $this->session->set_flashdata('flash_message', ucwords('settings_updated'));
            redirect(base_url() . 'index.php?admin/system_settings/', 'refresh');
        }
        if ($param1 == 'change_skin') {
            ...
            $this->db->update('settings' , $data);
            $this->session->set_flashdata('flash_message' , ucwords('theme_selected')); 
            redirect(base_url() . 'index.php?admin/system_settings/', 'refresh'); 
        }
        $page_data['page_name']  = 'system_settings';
        $page_data['page_title'] = ucwords('system_settings');
    ...
    function sms_settings($param1 = '' , $param2 = '')
    {
        ...
        $page_data['page_title'] = ucwords('sms_settings');
        $page_data['settings']   = $this->db->get('settings')->result_array();
        $this->load->view('backend/index', $page_data);
    }
    ...
    function manage_language($param1 = '', $param2 = '', $param3 = '')
    {
		...
		$page_data['page_title']       = ucwords('manage_language');
    ...
    function backup_restore($operation = '', $type = '')
    {
        ...
        $page_data['page_title'] = ucwords('manage_backup_restore');
        $this->load->view('backend/index', $page_data);
    }
    ...
    function manage_profile($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'update_profile_info') {
            ...
            $this->session->set_flashdata('flash_message', ucwords('account_updated'));
        ...
        if ($param1 == 'change_password') {
            ...
            if ($current_password == $data['password'] && $data['new_password'] == $data['confirm_new_password']) {
                ...
                $this->session->set_flashdata('flash_message', ucwords('password_updated'));
            } else {
                $this->session->set_flashdata('flash_message', ucwords('password_mismatch'));
            }
            redirect(base_url() . 'index.php?admin/manage_profile/', 'refresh');
        }
        $page_data['page_name']  = 'manage_profile';
        $page_data['page_title'] = ucwords('manage_profile');
